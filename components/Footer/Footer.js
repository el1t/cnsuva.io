...
class Footer extends React.Component {
	...
	render() {
		return (
			<footer className={cx('mdl-mini-footer', s.footer, this.props.className)}>
				<div className="mdl-mini-footer__left-section">
					<div className="mdl-logo">©&nbsp;CNS@UVA</div>
					{/*<ul className="mdl-mini-footer__link-list">*/}
					{/*<li><Link to="/privacy">Privacy & Terms</Link></li>*/}
					{/*<li><Link to="/not-found">Not Found</Link></li>*/}
					{/*</ul>*/}
				</div>
				<small className={s.middle}>
					Although this organization has members who are University of Virginia students and may have
					University employees associated or engaged in its activities and affairs, the organization is not
					a part of or an agency of the University. It is a separate and independent organization which is
				...
				<div className="mdl-mini-footer__right-section">
					<ul className="mdl-mini-footer__link-list">
						<li className="mdl-mini-footer--social-btn" style={{ backgroundColor: 'transparent' }}>
							<a href="https://github.com/cnsuva/cnsuva.io" role="button" title="GitHub">
